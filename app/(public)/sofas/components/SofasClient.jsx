...
const SofasClient = ({sofasCat}) => {
  // console.log('Sofas Category in Client:', sofasCat);
  if (!sofasCat || !sofasCat.subcategories?.length) {
    return (
